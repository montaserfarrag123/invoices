...
@section('content')
    ...
    @if (session()->has('archive_invoice'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم نقل الفاتوره الي الارشيف بنجاح",
                    type: "success"
                })
            }
        </script>
    ...
    @if (session()->has('restore_invoices'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم استعادة الفاتوره من الارشيف بنجاح ",
                    type: "success"
                })
            }
        </script>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ url('/invoices/create') }}" class="btn btn-primary">اضافة فاتوره</a>
                    </div>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="border-bottom-0">اجمالي الضريبه</th>
