							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id='notification_count'>  عددالاشعارات الغير مقروءه : {{auth()->user()->unreadNotifications()->count()}}</p>
									</div>
                                    <div id="unreaednotifications">
